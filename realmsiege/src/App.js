...
import BloodMoon from'./pages/BloodMoon';
...
<div style={{fontFamily:'Cinzel,serif',fontSize:'1.35rem',color:'#fff',margin:'1rem 0'}}>Page Not Found</div>
<p style={{color:'var(--muted)',marginBottom:'2rem'}}>The realm you seek does not exist.</p>
<a href="/" className="btn btn-s">Return Home</a>
</div>);}
...
<Route path="/wiki/blood-moon" element={<BloodMoon/>}/>
<Route path="/wiki/contracts" element={<Contracts/>}/>
<Route path="/wiki/rifts" element={<Rifts/>}/>
<Route path="/wiki/steam-market" element={<SteamMarket/>}/>
